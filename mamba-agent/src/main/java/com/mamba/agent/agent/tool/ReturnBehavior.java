package com.mamba.agent.agent.tool;
 ...
 * {@code com.mamba.agent.service.Result}.
 * <p>
 ...
 * {@code com.mamba.agent.service.Result} as their return type. Using either on a service with
...
public enum ReturnBehavior {
     ...
     * {@code com.mamba.agent.service.Result}) when every tool in the response is
     ...
     * </pre>
     * <p>
     * Only allowed on AI services returning {@code com.mamba.agent.service.Result}.
     */
    IMMEDIATE,
