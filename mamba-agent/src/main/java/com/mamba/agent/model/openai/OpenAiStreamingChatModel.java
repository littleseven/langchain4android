package com.mamba.agent.model.openai;

import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.onCompleteResponse;
import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.onCompleteToolCall;
import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.onPartialResponse;
import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.onPartialThinking;
import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.onPartialToolCall;
import static com.mamba.agent.internal.InternalStreamingChatResponseHandlerUtils.withLoggingExceptions;
import static com.mamba.agent.internal.Utils.copy;
import static com.mamba.agent.internal.Utils.getOrDefault;
import static com.mamba.agent.internal.Utils.isNotNullOrEmpty;
import static com.mamba.agent.internal.Utils.isNullOrEmpty;
import static com.mamba.agent.model.ModelProvider.OPEN_AI;
import static com.mamba.agent.spi.ServiceHelper.loadFactories;
import static com.mamba.agent.model.openai.internal.OpenAiUtils.DEFAULT_OPENAI_URL;
import static com.mamba.agent.model.openai.internal.OpenAiUtils.DEFAULT_USER_AGENT;
import static com.mamba.agent.model.openai.internal.OpenAiUtils.fromOpenAiResponseFormat;
import static com.mamba.agent.model.openai.internal.OpenAiUtils.toOpenAiChatRequest;
import static com.mamba.agent.model.openai.internal.OpenAiUtils.validate;
...
import com.mamba.agent.internal.ExceptionMapper;
import com.mamba.agent.internal.ToolCallBuilder;
...
import com.mamba.agent.model.openai.internal.ParsedAndRawResponse;
import com.mamba.agent.model.openai.internal.chat.ChatCompletionChoice;
...
import com.mamba.agent.model.openai.internal.chat.Delta;
import com.mamba.agent.model.openai.internal.chat.ToolCall;
import com.mamba.agent.model.openai.internal.shared.StreamOptions;
import com.mamba.agent.model.openai.spi.OpenAiStreamingChatModelBuilderFactory;
