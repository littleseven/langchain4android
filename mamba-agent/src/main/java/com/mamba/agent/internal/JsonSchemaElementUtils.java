...
import static com.mamba.agent.internal.PolymorphicTypes.discriminatorPropertyName;
import static com.mamba.agent.internal.PolymorphicTypes.discriminatorValue;
import static com.mamba.agent.internal.PolymorphicTypes.findConcreteSubtypes;
import static com.mamba.agent.internal.PolymorphicTypes.isPolymorphic;
import static com.mamba.agent.internal.PolymorphicTypes.verifyJsonTypeInfoIsSupported;
import static com.mamba.agent.internal.Utils.generateUUIDFrom;
import static java.lang.reflect.Modifier.isStatic;
import static java.util.Arrays.stream;

import com.mamba.agent.Internal;
import com.mamba.agent.model.chat.request.json.JsonAnyOfSchema;
import com.mamba.agent.model.chat.request.json.JsonArraySchema;
...
import com.mamba.agent.model.chat.request.json.JsonNullSchema;
...
import com.mamba.agent.model.chat.request.json.JsonReferenceSchema;
...
import com.mamba.agent.model.output.structured.Description;
...
public class JsonSchemaElementUtils {
    ...
    private static JsonSchemaElement addDiscriminator(
        ...
        if (obj.properties().containsKey(discriminatorProperty)) {
            // The discriminator field is allowed to coexist with a same-named bean field.
            // In Android/Gson mode, we allow this without strict Jackson checks.
    ...
    private static boolean isRequired(Field field, boolean defaultValue) {
        // Jackson @JsonProperty removed; always use default value
        return defaultValue;
    }
