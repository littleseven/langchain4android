...
| **人脸检测** | 多引擎可插拔：ONNX Runtime（默认，NNAPI 加速）/ MediaPipe（TFLite GPU）/ NCNN（Vulkan）/ MNN（Vulkan），统一输出 106 点 |
...
| 人脸检测多引擎 | ✅ | ONNX / MediaPipe / NCNN / MNN 四引擎可插拔，统一输出 106 点 |
...
| [`docs/FACE_DETECTION_ENGINE_ARCHITECTURE.md`](docs/FACE_DETECTION_ENGINE_ARCHITECTURE.md) | 人脸检测多引擎架构（ONNX / MediaPipe / NCNN / MNN） | ✅ |
