...
import static com.mamba.internal.JsonSchemaElementUtils.toMap;
import static com.mamba.internal.ToolSpecificationUtils.isEffectivelyStrict;
import static com.mamba.internal.Utils.getOrDefault;
import static com.mamba.internal.Utils.isNotNullOrBlank;
import static com.mamba.internal.Utils.isNullOrBlank;
import static com.mamba.internal.Utils.isNullOrEmpty;
import static com.mamba.internal.ValidationUtils.ensureNotBlank;
import static com.mamba.model.chat.request.ResponseFormat.JSON;
import static com.mamba.model.chat.request.ResponseFormatType.TEXT;
import static com.mamba.model.openai.internal.chat.ResponseFormatType.JSON_OBJECT;
import static com.mamba.model.openai.internal.chat.ResponseFormatType.JSON_SCHEMA;
import static com.mamba.model.openai.internal.chat.ToolType.FUNCTION;
import static com.mamba.model.output.FinishReason.CONTENT_FILTER;
import static com.mamba.model.output.FinishReason.LENGTH;
import static com.mamba.model.output.FinishReason.STOP;
import static com.mamba.model.output.FinishReason.TOOL_EXECUTION;
...
import com.mamba.data.image.Image;
import com.mamba.data.message.AiMessage;
import com.mamba.data.message.AudioContent;
import com.mamba.data.message.ChatMessage;
import com.mamba.data.message.Content;
import com.mamba.data.message.ImageContent;
import com.mamba.data.message.PdfFileContent;
...
import com.mamba.data.message.VideoContent;
import com.mamba.data.video.Video;
import com.mamba.exception.ContentFilteredException;
...
import com.mamba.model.chat.request.ResponseFormat;
import com.mamba.model.chat.request.ToolChoice;
import com.mamba.model.chat.request.json.JsonObjectSchema;
import com.mamba.model.chat.request.json.JsonRawSchema;
import com.mamba.model.chat.request.json.JsonSchema;
import com.mamba.model.chat.response.ChatResponse;
import com.mamba.model.openai.LogProb;
import com.mamba.model.openai.OpenAiChatRequestParameters;
import com.mamba.model.openai.OpenAiTokenUsage;
import com.mamba.model.openai.OpenAiTokenUsage.InputTokensDetails;
import com.mamba.model.openai.OpenAiTokenUsage.OutputTokensDetails;
import com.mamba.model.openai.internal.chat.AssistantMessage;
...
import com.mamba.model.openai.internal.chat.ContentType;
import com.mamba.model.openai.internal.chat.Function;
import com.mamba.model.openai.internal.chat.FunctionCall;
import com.mamba.model.openai.internal.chat.FunctionMessage;
import com.mamba.model.openai.internal.chat.ImageDetail;
import com.mamba.model.openai.internal.chat.ImageUrl;
import com.mamba.model.openai.internal.chat.InputAudio;
import com.mamba.model.openai.internal.chat.LogProbs;
import com.mamba.model.openai.internal.chat.Message;
import com.mamba.model.openai.internal.chat.PdfFile;
import com.mamba.model.openai.internal.chat.Tool;
import com.mamba.model.openai.internal.chat.ToolCall;
import com.mamba.model.openai.internal.chat.ToolChoiceMode;
import com.mamba.model.openai.internal.chat.ToolMessage;
import com.mamba.model.openai.internal.chat.VideoUrl;
import com.mamba.model.openai.internal.shared.CompletionTokensDetails;
import com.mamba.model.openai.internal.shared.PromptTokensDetails;
import com.mamba.model.openai.internal.shared.Usage;
...
public class OpenAiUtils {
    ...
    public static Message toOpenAiMessage(ChatMessage message, boolean sendThinking, String thinkingFieldName) {
        if (message instanceof SystemMessage) {
            return com.mamba.model.openai.internal.chat.SystemMessage.from(((SystemMessage) message).text());
        }

        if (message instanceof UserMessage userMessage) {
            if (userMessage.hasSingleText()) {
                return com.mamba.model.openai.internal.chat.UserMessage.builder()
    ...
    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(Content content) {
    ...
    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(TextContent content) {
        return com.mamba.model.openai.internal.chat.Content.builder()
                .type(ContentType.TEXT)
                .text(content.text())
                .build();
    }

    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(ImageContent content) {
        return com.mamba.model.openai.internal.chat.Content.builder()
    ...
    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(VideoContent content) {
        return com.mamba.model.openai.internal.chat.Content.builder()
    ...
    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(AudioContent audioContent) {
        return com.mamba.model.openai.internal.chat.Content.builder()
    ...
    private static com.mamba.model.openai.internal.chat.Content toOpenAiContent(PdfFileContent pdfFileContent) {
        String fileData;
    ...
    private static LogProb toLogProb(com.mamba.model.openai.internal.chat.LogProb internal) {
    ...
    static com.mamba.model.openai.internal.chat.ResponseFormat toOpenAiResponseFormat(
        ...
        if (jsonSchema == null) {
            return com.mamba.model.openai.internal.chat.ResponseFormat.builder()
                    .type(JSON_OBJECT)
                    .build();
        } else {
            ...
            com.mamba.model.openai.internal.chat.JsonSchema openAiJsonSchema =
                    com.mamba.model.openai.internal.chat.JsonSchema.builder()
