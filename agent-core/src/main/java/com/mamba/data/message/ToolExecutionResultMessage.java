...
import static com.mamba.data.message.ChatMessageType.TOOL_EXECUTION_RESULT;
...
public class ToolExecutionResultMessage implements ChatMessage {
     ...
     * These attributes are not sent to the LLM, but can be persisted in a {@link com.mamba.memory.ChatMemory}.
     *
     * @since 1.12.0
     */
