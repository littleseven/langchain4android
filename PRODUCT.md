...
**当前聚焦**：从「相机工具」向「AI 相册助手」转型，以相册首页为核心入口，AI 对话、相机、设置、模型中心作为二级能力被 plus 菜单聚合，相册/编辑作为核心能力被 Agent 调度。
...
3. **首页转型**：相册页作为应用默认首页，聊天页、相机页、设置页、模型中心页作为二级页从相册 plus 菜单进入。相机降级为辅助入口，相册+编辑升级为核心能力，AI 对话作为核心二级能力。
...
- 右下角 plus 菜单聚合 Chat / Camera / Settings / Model Center 四个二级入口
