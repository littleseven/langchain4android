---
name: error-healer
description: PicMe 编译错误自动分类与修复策略。将 Kotlin/Gradle 编译错误映射到标准化修复方案，提升 AI Agent 自愈成功率和修复效率。Use when encountering compilation errors, build failures, or when guiding the Self-Heal loop in PicMe development.
---
...
| `av-gl-expert` Skill | Shader/EGL 相关错误时读取 |
| `coordinate-system-standard` Skill | 坐标相关错误时读取 |
| `mediapipe-landmark-mapping` Skill | 人脸关键点相关错误时读取 |
