...
```bash
# 自动读取当前检查清单
cat .qoder/skills/rd-reflection/CHECKLIST.md
```
...
```bash
# 启动新任务（读取检查清单）
./.qoder/skills/rd-reflection/scripts/new_task.sh "任务名称"

# 任务复盘（引导 5 个问题，自动更新清单和日志）
./.qoder/skills/rd-reflection/scripts/reflect.sh

# 生成月度进化报告
./.qoder/skills/rd-reflection/scripts/evolution_report.sh

# 将经验同步到相关 skill
./.qoder/skills/rd-reflection/scripts/update_skill.sh adb-bot
```
