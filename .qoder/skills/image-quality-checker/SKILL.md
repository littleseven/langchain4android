...
.qoder/skills/image-quality-checker/scripts/auto_check_photo.sh
```

### 2. 截屏并分析预览画面
```bash
cd /Users/guoshuai/AndroidStudioProjects/PicMe/.qoder/skills/image-quality-checker/scripts
./check_quality.sh
```
