...
# 检查代码中无 HTTP/网络请求
grep -r "http\|HttpClient\|OkHttp\|Retrofit" app/src/main/java/com/picme/ --include="*.kt"
```
...
| [doc-sync-guardian](.qoder/skills/doc-sync-guardian/SKILL.md) | 文档一致性检查 |
| [compose-ui-expert](.qoder/skills/compose-ui-expert/SKILL.md) | UI 布局与交互验收 |
| [perf-optimizer](.qoder/skills/perf-optimizer/SKILL.md) | 性能基线对比 |
| [i18n-validator](.qoder/skills/i18n-validator/SKILL.md) | 多语言同步验证 |
