...
│ .so             │ │            │ │                   │
│                 │ │            │ │                   │
│ ├─ Keyword      │ │ Qwen3-1.7B │ │ Det10G + 2D106   │
│ │  Spotter(KWS) │ │            │ │                   │
│ ├─ OnlineRecog  │ │            │ │                   │
│ │  nizer(ASR)   │ │            │ │                   │
│ └─ Vad(DNN VAD) │ │            │ │                   │
...
| ③ LLM 推理 | 25MB(PAUSED) | — | 1.47GB | 70MB | 35MB | 700MB | **2.30GB** | ~3.0GB |
| **④ ⚠️ ASR+LLM** | **25MB** | **400MB** | **1.47GB** | **70MB** | **35MB** | **700MB** | **2.70GB** | **~3.4GB** |
...
3. **LLM 推理 (~2.3GB)** 需要 8GB+ 设备，中低端需要降级到远程推理
4. **ASR + LLM 同时 (~2.7GB)** 仅在 12GB+ 设备安全，**不应作为默认行为**
