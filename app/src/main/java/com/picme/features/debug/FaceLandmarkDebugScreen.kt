...
private fun DebugLandmarkCanvas(
    ...
    Canvas(modifier = Modifier.fillMaxSize()) {
        ...
        if (show468Points && mediaPipe468Points != null) {
            ...
            val leftEyeIndices = setOf(33, 246, 161, 160, 159, 158, 157, 173, 133, 155, 154, 153, 145, 144)
            val rightEyeIndices = setOf(362, 398, 384, 385, 386, 387, 388, 466, 463, 380, 381, 382, 374, 372)
