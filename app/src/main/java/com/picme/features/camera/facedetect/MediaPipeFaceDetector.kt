...
class MediaPipeFaceDetector(context: Context) {
    ...
    companion object {
        ...
        private val NON_CONTOUR_MAPPING = intArrayOf(
            ...
            //   47=左外(275), 48=左内(48), 49=中心(4), 50=右内(51), 51=右外(357)
            // 对称性：47(275)↔51(357)关于中心对称，48(48)↔50(51)关于中心对称
            275, 48, 4, 51, 357,
            ...
            //   位于眉心43(168)两侧，离眼角一步距离
            //   115=鼻梁右侧(离右内眼角一步), 135=鼻梁左侧(离左内眼角一步)
            //   对称性：115↔135 关于鼻梁中线对称
            115, 135,
