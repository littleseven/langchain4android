...
class MediaPipeFaceDetector(context: Context) {
    ...
    companion object {
        ...
        private val NON_CONTOUR_MAPPING = intArrayOf(
            ...
            //   91-95=下唇5点(不含嘴角): 405→314→17(下唇中心)→84→181
            ...
            // 对称映射（以中心点为对称轴）：
            //   上唇: 97=82(左1), 98=13(中心), 99=312(右1) —— 82/312 关于13对称
            //   下唇: 101=87(右1), 102=14(中心), 103=317(左1) —— 87/317 关于14对称
            78, 82, 13, 312, 308, 87, 14, 317,
