...
class MediaPipeFaceDetector(context: Context) {
    ...
    companion object {
        ...
        private val NON_CONTOUR_MAPPING = intArrayOf(
            ...
            // 基于 MediaPipe 左眼语义关键点：
            //   33=外眼角, 246=上眼睑外, 161=上眼睑中1, 160=上眼睑中2, 159=上眼睑内, 158=过渡
            33, 246, 161, 160, 159, 158,

            // === 右眼外轮廓 58-63 (6点) - 从右外角顺时针 ===
            // 基于 MediaPipe 右眼语义关键点（与左眼对称）：
            //   362=外眼角, 398=上眼睑外, 384=上眼睑中1, 385=上眼睑中2, 386=上眼睑内, 387=过渡
            ...
            // 基于 MediaPipe 左眼语义关键点：
            //   133=内眼角, 153=下眼睑中, 468=瞳孔中心(478点模式)
            133, 153, 468,

            // === 右眼内/下 75-77 (3点) - 75=右眼内角, 76=下眼睑中, 77=右瞳孔 ===
            // 基于 MediaPipe 右眼语义关键点：
            //   263=内眼角(靠近鼻梁), 466=下眼睑中, 473=瞳孔中心(478点模式)
            263, 466, 473,
